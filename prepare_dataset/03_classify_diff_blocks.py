...
if __name__=="__main__":
    ...
    for p_name in ['camel', 'hadoop', 'linux', 'zephyr']:
        ...
        repo_dir = "./cregit_repository/{0}"

        print("\n===\nstudied project: {0}".format(p_name))
        data_dict = {}

        for idx, commit_hash in enumerate(git_reader.get_all_hash(repo_dir.format(p_name))[1:]):
        ...
        util.dump_pickle("./pickle/diff_block_{0}.pickle".format(p_name), data_dict)
